...
#spark_sql_ETL_bb2.py start (Very very very Important Bread & Butter2) - FBP-SQL/DSL (FBP-SQL)
...
df_col_added_renamed_analysed_removed_upper_case_casted_reorder=df_col_added_renamed_analysed_removed_upper_case_casted.select("custid","fname","lname","profession","age","sourcesystem")
